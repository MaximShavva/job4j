...
/**
 * Класс для отображения графики игры крестики-нолики.
 */
public class TicTacToe extends Application {
    ...
    /**
     * Массив определяет, в каких клетках есть фишки Х и 0.
     */
    private final Figure3T[][] cells = new Figure3T[size][size];

    /**
     * Логика игры: содержит проверки выигрышных комбинаций и возможности
     * ходить дальше.
     */
