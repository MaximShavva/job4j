 ...
 * Тип - жадный синглтон на статическом поле.
 *
 * @author Шавва Максим.
 * @version 1.
 * @since 02.04.2019г.
 */
public class TrackerEagerField implements Tracking {

    /**
     * Хранит экземпляр - синглтон TrackerLazyField.
     */
    private static final TrackerEagerField INSTANCE = new TrackerEagerField();
     ...
     */
    public static TrackerEagerField getInstance() {
        return INSTANCE;
    }
